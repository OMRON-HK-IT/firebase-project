...
class Form_detection:
    def __init__(self):
        self.company_name = 'RPA'
        self.function_name = 'PDF OCR automation'
        self.template = r'D:\Desktop\Desktop_2\1.Python_project\Form_detection\template\logistic_template.jpg'
        self.target = r''
        self.PDF_file = r"D:\Desktop\Desktop_2\1.Python_project\Form_detection\source\OEH1.pdf"

        self.pdf_dir = r"D:\Desktop\Desktop_2\1.Python_project\Form_detection\source"
        self.source_img_dir = r"D:\Desktop\Desktop_2\1.Python_project\Form_detection\UserForms"
        self.per = 25
    ...
    def convert_pdf2img(self):
        ...
        for pdf_file in os.listdir(self.pdf_dir):  # convert pdf to image
            pdfToimage._pdf2image(self.source_img_dir,pdf_file)  # 300dpi
    ...
    def main(self):
        ...
        myPicList = os.listdir(self.source_img_dir)
        # print(myPicList)
        for j, y in enumerate(myPicList):
            try:
                jpg_dict = {}
                in_file = os.path.join(self.source_img_dir, y)
                ...
                img = cv2.imread(os.path.join(self.source_img_dir,y))
                ...
                # print(f'################## Extracting Data from {self.head_tail[1]}  ##################')
